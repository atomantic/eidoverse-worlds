...
// The log records that `vesper.wright` spawned a crate, and nothing anywhere
// says that body is one of six an instance called Vesper fields, or that
// Vesper is a chief-of-staff mind on a PortOS install, or that the install
 ...
 *  `agent:vesper.wright@portos` → `vesper.wright`. Bodies join under short
